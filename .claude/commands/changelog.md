...
3. Con los MRs restantes, evaluá cuáles afectan directamente la experiencia del usuario final
   (no solo infra interna, refactors de código, o cambios de configuración sin impacto visible).
...
4. Para los user-facing, escribí entradas en español claro, sin jerga técnica.
   ...
   Agrupá en estas secciones (omití las que queden vacías):
   - ✨ Novedades
   - 🔧 Mejoras
   - 🐛 Bugs resueltos

5. Escribí el resultado en `changelogs/YYYY-WW.md` donde WW es la semana ISO actual
   (ej: `changelogs/2026-22.md`).
